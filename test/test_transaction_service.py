...
class TestTransactionService(TestCase):
    ...
    transaction1: TransactionRequest
    ...
    def setUp(self) -> None:
        ...
        self.transaction1 = TransactionRequest()
        ...
        self.transaction1.set_amount(500)
        self.transaction1.set_sender_pin("1234")
        self.transaction1.set_account_id_num(self.account1.get_id_num())
        self.transaction1.set_recipient_account_number(self.account2.get_account_number())
        self.transaction_service.transfer(self.transaction1)
    ...
    def test_find_all_transactions(self):
        self.assertEqual(2, len(self.transaction_service.find_all_transactions()))

    def test_find_all_by_account_number(self):
        account_transaction: str = self.transaction_service.find_all_by_account_number(self.account1.get_account_number())
        self.assertEqual(2, len(account_transaction))
